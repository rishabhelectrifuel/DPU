...
extern uint32_t ADC_Count_DPU[4];
...
#define CCLK_ENCOD_Pin GPIO_PIN_4
#define CCLK_ENCOD_GPIO_Port GPIOC
#define DT_ENCOD_Pin GPIO_PIN_5
#define DT_ENCOD_GPIO_Port GPIOC
